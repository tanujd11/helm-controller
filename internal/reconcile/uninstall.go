...
func (r *Uninstall) failure(req *Request, buffer *action.LogBuffer, err error) {
	...
	conditions.MarkFalse(req.Object, helmv2.ReleasedCondition, helmv2.UninstallFailedReason, msg)
...
func (r *Uninstall) success(req *Request) {
	...
	conditions.MarkFalse(req.Object, helmv2.ReleasedCondition, helmv2.UninstallSucceededReason, msg)
