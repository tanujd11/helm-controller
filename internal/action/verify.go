...
func ReleaseTargetChanged(obj *helmv2.HelmRelease, chartName string) bool {
	cur := obj.GetCurrent()
	switch {
...
func VerifyReleaseInfo(config *helmaction.Configuration, info *helmv2.HelmReleaseInfo) (rls *helmrelease.Release, err error) {
	if info == nil {
...
// ErrReleaseDigest or ErrReleaseNotObserved indicating the reason for the
// verification failure.
func VerifyLastStorageItem(config *helmaction.Configuration, info *helmv2.HelmReleaseInfo) (rls *helmrelease.Release, err error) {
	if info == nil {
		return nil, ErrReleaseNotFound
	}
...
func VerifyReleaseObject(info *helmv2.HelmReleaseInfo, rls *helmrelease.Release) error {
...
func VerifyRelease(rls *helmrelease.Release, info *helmv2.HelmReleaseInfo, chrt *helmchart.Metadata, vals helmchartutil.Values) error {
	if rls == nil {
